...
ros2 service call /panda_param_service_server/set_full_collision_behavior franka_msgs/srv/SetFullCollisionBehavior "{
...
# Joint stiffness
# ros2 service call /panda_param_service_server/set_joint_stiffness franka_msgs/srv/SetJointStiffness "{
