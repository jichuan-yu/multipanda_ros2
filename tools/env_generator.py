...
Generates MuJoCo XML and MPRC YAML from user-defined config files.
...
class EnvGenerator:
    ...
    def generate_mprc_yaml(self) -> str:
        ...
        lines.append(f'# Total objects: {len(self.config.collision_objects)}')
        lines.append('')
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate MuJoCo XML and MPRC YAML from config files',
